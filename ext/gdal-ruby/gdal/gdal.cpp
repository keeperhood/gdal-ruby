...
int GDAL_GetDriverCount() {
  return GDALGetDriverCount();
}


GDALDriverShadow* GDAL_GetDriverByName( char const *name ) {
  return (GDALDriverShadow*) GDALGetDriverByName( name );
}


GDALDriverShadow* GDAL_GetDriver( int i ) {
...
fail:
  Ruby_Format_OverloadedError( argc, 1, "push_error_handler", 
    "    CPLErr push_error_handler(char const *pszCallbackName)\n"
...
SWIGINTERN void
free_GDALColorEntry(void *self) {
    GDALColorEntry *arg1 = (GDALColorEntry *)self;
    delete arg1;
}
...
SWIGINTERN void
free_GDAL_GCP(void *self) {
    GDAL_GCP *arg1 = (GDAL_GCP *)self;
...
SWIGINTERN void
free_GDALAsyncReaderShadow(void *self) {
    GDALAsyncReaderShadow *arg1 = (GDALAsyncReaderShadow *)self;
...
SWIGINTERN void
free_GDALDatasetShadow(void *self) {
    GDALDatasetShadow *arg1 = (GDALDatasetShadow *)self;
...
SWIGINTERN void
free_GDALColorTableShadow(void *self) {
    GDALColorTableShadow *arg1 = (GDALColorTableShadow *)self;
...
SWIGINTERN void
free_GDALRasterAttributeTableShadow(void *self) {
    GDALRasterAttributeTableShadow *arg1 = (GDALRasterAttributeTableShadow *)self;
...
SWIGINTERN void
free_GDALTransformerInfoShadow(void *self) {
    GDALTransformerInfoShadow *arg1 = (GDALTransformerInfoShadow *)self;
...
_wrap_Transformer_transform_point__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  arg2 = static_cast< int >(val2);
  {
    ...
    /* Get the length */
    int seq_size = RARRAY_LEN(argv[1]);
...
SWIGINTERN VALUE
_wrap_gdal_get_driver_count(int argc, VALUE *argv, VALUE self) {
  int result;
  VALUE vresult = Qnil;
  ...
  {
    CPLErrorReset();
    result = (int)GDAL_GetDriverCount();
    CPLErr eclass = CPLGetLastErrorType();
    if ( eclass == CE_Failure || eclass == CE_Fatal ) {
      SWIG_exception( SWIG_RuntimeError, CPLGetLastErrorMsg() );
...
SWIGINTERN VALUE
_wrap_gdal_get_driver_by_name(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(argv[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","GDAL_GetDriverByName", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  {
    if (!arg1) {
  ...
  {
    CPLErrorReset();
    result = (GDALDriverShadow *)GDAL_GetDriverByName((char const *)arg1);
    CPLErr eclass = CPLGetLastErrorType();
    if ( eclass == CE_Failure || eclass == CE_Fatal ) {
      SWIG_exception( SWIG_RuntimeError, CPLGetLastErrorMsg() );
...
SWIGINTERN VALUE
_wrap_gdal_get_driver(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  GDALDriverShadow *result = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","GDAL_GetDriver", 1, argv[0] ));
  } 
  arg1 = static_cast< int >(val1);
  {
    CPLErrorReset();
    result = (GDALDriverShadow *)GDAL_GetDriver(arg1);
    CPLErr eclass = CPLGetLastErrorType();
    if ( eclass == CE_Failure || eclass == CE_Fatal ) {
      SWIG_exception( SWIG_RuntimeError, CPLGetLastErrorMsg() );
...
SWIGEXPORT void Init_gdal(void) {
  ...
  rb_define_module_function(mGdal, "get_driver_count", VALUEFUNC(_wrap_gdal_get_driver_count), -1);
  rb_define_module_function(mGdal, "get_driver_by_name", VALUEFUNC(_wrap_gdal_get_driver_by_name), -1);
  rb_define_module_function(mGdal, "get_driver", VALUEFUNC(_wrap_gdal_get_driver), -1);
